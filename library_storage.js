...
/* get and set methods use callback functions to determine their inner
 * workings. They check to make sure a function has been passed, and
 * call it if it has. Otherwise, they just pass along whatever was in
 * storage (get) or whatever was passed in (set).
*/
localStoragePrototype.get = function(callback) {
